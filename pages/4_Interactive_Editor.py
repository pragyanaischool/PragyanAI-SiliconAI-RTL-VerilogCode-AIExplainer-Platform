...
# Page Configuration
st.set_page_config(
    page_title="PragyanAI - Interactive Editor & Save Studio",
    page_icon="✏️",
    layout="wide"
)
try:
...
st.markdown(
    ...
    "run on-demand compilation checks, save your edits to the session, and download your files."
)
...
with col_btn4:
    st.download_button(
        label="📥 Download TB (`test_bench.v`)",
        data=edited_tb,
        file_name="test_bench.v",
        mime="text/plain"
    )
